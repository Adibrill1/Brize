...
const STRINGS = {
  en: {
    ...
    empty_hint: 'Tap anywhere on the map to add your first item',
    new_entity: 'New item',
    edit_entity: 'Edit item',
    name: 'Name',
    ...
    about_me: 'About me (context for AI drafts — write in English)',
    ...
    workspace_name_ph: 'e.g. My Europe Trip, Family, Company…',
    template: 'Template',
    create: 'Create',
    confirm_delete_workspace: 'Delete workspace "{name}" and everything inside it?',
  ...
  he: {
    ...
    empty_hint: 'הקישו על המפה כדי להוסיף פריט ראשון',
    new_entity: 'פריט חדש',
    edit_entity: 'עריכת פריט',
    name: 'שם',
    ...
    monthly_budget: 'יעד תקציב חודשי',
    about_me: 'קצת עליי (הקשר לטיוטות AI — מומלץ באנגלית)',
    ...
    workspace_name: 'שם המרחב',
    workspace_name_ph: 'למשל: הטיול לאירופה, משפחה, חברה…',
    template: 'תבנית',
    create: 'יצירה',
    confirm_delete_workspace: 'למחוק את המרחב "{name}" ואת כל מה שבתוכו?',
    template_travel: 'מסע',
    template_blank: 'ריק',
    item: 'פריט',
    open: 'פתוח',
